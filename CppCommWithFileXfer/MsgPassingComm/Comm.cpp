...
namespace MsgPassingCommunication
{
  Context::Context()
  {
    saveFilePath = "C:/SU/temp/Project4Sample/CppCommWithFileXfer/SaveFiles";  // default staging area for incoming files
    sendFilePath = "C:/SU/temp/Project4Sample/CppCommWithFileXfer/SendFiles";  // default staging area for outgoing files
  }
  Context ctx;
