...
*  ver 1.5 : 28 May 2017
*  - minor changes to console display during execution, e.g., just show file
*    name, not entire path
*  - changed ActionsAndRules to fix exceptions thrown on code that doesn't
*    compile.
*  ver 1.4 : 26 Feb 2016
